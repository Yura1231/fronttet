...
async function loadUserEvents() {
    try {
        let response = await fetch("https://newsse-852faa67b80a.herokuapp.com/my-events/", {
            method: "GET",
            headers: {
...
async function loadSubscribedEvents() {
    try {
        let response = await fetch("https://newsse-852faa67b80a.herokuapp.com/my-subscriptions/", {
            method: "GET",
            headers: {
                "Authorization": "Bearer " + localStorage.getItem("access_token"),
                "Content-Type": "application/json",
...
async function loadUserComments() {
    try {
        let response = await fetch("https://newsse-852faa67b80a.herokuapp.com/comments/", {
            method: "GET",
            headers: {
                "Authorization": "Bearer " + localStorage.getItem("access_token"),
                "Content-Type": "application/json",
        ...
        comments.forEach(comment => {
            ...
            commentElement.innerHTML = `
                <div class="review-item">
                    <img src="https://newsse-852faa67b80a.herokuapp.com${comment.author_profile_picture}" alt="User Avatar" class="user-avatar">
